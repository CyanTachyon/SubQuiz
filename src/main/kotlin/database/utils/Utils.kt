...
fun Query.asSlice(begin: Long, count: Int): Slice<ResultRow>
{
    ...
    val q1 = q.aliasOnly()
        ...
        .andWhere { rowNumber.aliasOnlyExpression() lessEq longParam(begin + count) }
