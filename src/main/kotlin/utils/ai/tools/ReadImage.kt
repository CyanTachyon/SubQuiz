...
object ReadImage
{
    ...
    init
    {
        ...
        { (chat, parm) ->
            ...
            {
                parseUrl(chat.id, it) ?: throw IllegalArgumentException("Image URL '$it' not found in chat ${chat.id}")
            ...
            return@registerTool AiToolInfo.ToolResult(Content(description))
        }
    }
}